        ...
        for e in range(EPISODES):
            ...
            while not done:
                ...
                if env.gameover:
                    ...
                    stats = [win_rate, loss_rate, self.global_step]
                ...
                self.agent.append_sample(state, action, reward, next_state, float(done))
                ...
                if self.global_step % 20000 == 0 and e > 2000:
                    self.agent.model.save_weights("./DQN_kake_model_0218.h5")

            if e > 100 and e % 100 == 0:
                win_rate = float(win_sum / 100)
                win_sum = 0

            if e > 100 and e % 100 == 0:
                loss_rate = float(loss_sum / 100)
                loss_sum = 0
        
            print("player ", env.game_turn % 4, "loss   episode : ", e, "  epsilon : ", self.agent.epsilon, " win_rate : ", win_rate, " loss_rate : ", loss_rate)
            if env.game_turn % 4 == 0 or env.game_turn % 4 == 2:
                print("com_1 win!!")
